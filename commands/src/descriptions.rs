...
pub static CONFIG: &str = "Accesses the configuration store";
...
// Config subcommands
pub mod config {
    pub static GET: &str = "Gets a value from the configuration store";
    pub static SET: &str = "Sets a value in the configuration store";
